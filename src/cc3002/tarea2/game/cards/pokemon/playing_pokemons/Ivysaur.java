...
public class Ivysaur extends GrassPhase1Pokemon {
    /**
     ...
     */
    public Ivysaur(int hp, int id, String name, IAbility[] abilities, Trainer trainer) {
        super(hp, id, name, abilities, trainer);
    }

    public Ivysaur(Trainer trainer) {
        this(70, 2, "Ivysaur", new IAbility[] {new ScratchAttack(), new MegaKickAttack()}, trainer);
    }
