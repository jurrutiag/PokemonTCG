...
public class Charmander extends FireBasePokemon {
    /**
     ...
     */
    public Charmander(int hp, int id, String name, IAbility[] abilities, Trainer trainer) {
        super(hp, id, name, abilities, trainer);
    }

    public Charmander(Trainer trainer) {
        this(50, 4, "Charmander", new IAbility[] {new ScratchAttack(), new MegaKickAttack()}, trainer);
    }
}
