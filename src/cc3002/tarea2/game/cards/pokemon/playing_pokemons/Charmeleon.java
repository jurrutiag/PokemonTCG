...
public class Charmeleon extends FirePhase1Pokemon {
    /**
     ...
     */
    public Charmeleon(int hp, int id, String name, IAbility[] abilities, Trainer trainer) {
        super(hp, id, name, abilities, trainer);
    }

    public Charmeleon(Trainer trainer) {
        this(60, 5, "Charmeleon", new IAbility[] {new ScratchAttack(), new MegaKickAttack()}, trainer);
    }
