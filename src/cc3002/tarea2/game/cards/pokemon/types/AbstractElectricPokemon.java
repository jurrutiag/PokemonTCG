 ...
 * @author Juan Urrutia
 */
public abstract class AbstractElectricPokemon extends AbstractPokemonCard implements IElectricPokemon {
     ...
     */
    public AbstractElectricPokemon(int hp, int id, String name, IAbility[] abilities, Trainer trainer) {
