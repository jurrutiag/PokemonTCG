 ...
 * @author Juan Urrutia
 */
public abstract class AbstractFirePokemon extends AbstractPokemonCard implements IFirePokemon {
     ...
     */
    public AbstractFirePokemon(int hp, int id, String name, IAbility[] abilities, Trainer trainer) {
