 ...
 * @author Juan Urrutia
 */
public abstract class AbstractGrassPokemon extends AbstractPokemonCard implements IGrassPokemon {
     ...
     */
    public AbstractGrassPokemon(int hp, int id, String name, IAbility[] abilities, Trainer trainer) {
