...
/**
 * Class representing water phase 1 Pokemons.
 *
 * @author Juan Urrutia
 */
public abstract class WaterPhase1Pokemon extends AbstractWaterPokemon implements IPhase1Pokemon {
    ...
    /**
     * Creates a water type phase 1 pokemon.
     *
     ...
     */
    public WaterPhase1Pokemon(int hp, int id, String name, IAbility[] abilities, Trainer trainer) {
