 ...
 * @author Juan Urrutia
 */
public abstract class FightingType extends PokemonCard {

    /**
     * Creates a fighting type PokemonCard.
     ...
     */
    public FightingType(int hp, int id, String name, Attack[] attacks, Trainer trainer, IPhase phase) {
