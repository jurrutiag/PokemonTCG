 ...
 * @author Juan Urrutia
 */
public abstract class PsychicType extends PokemonCard {

    /**
     * Creates a psychic type PokemonCard.
     ...
     */
    public PsychicType(int hp, int id, String name, Attack[] attacks, Trainer trainer, IPhase phase) {
